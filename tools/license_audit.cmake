...
if(NOT _spdx_version STREQUAL "SPDX-2.3" OR NOT _package_count EQUAL 6 OR
   NOT _dependency_name STREQUAL "miniaudio" OR
   NOT _oboe_package_name STREQUAL "Oboe")
  message(FATAL_ERROR "The SPDX SBOM is incomplete")
endif()

message(STATUS "Dependency license audit passed for miniaudio 0.11.25 and Oboe 1.10.0")
