...
| M1 portable sound path | in progress | Native/Wasm synthesis, deterministic PCM16 WAV, a real browser AudioWorklet, and ESP32/ESP32-S3 I2S firmware builds are verified; realtime desktop and mobile platform call entries pending |
