...
|---|---|---|---|---|
| Windows x64 | runtime-verified (M5 headless service) | 2026-09-03 | VS 2026 18.8.0; MSVC 19.51.36248; miniaudio 0.11.25; WASAPI; Raw Input; Clang sanitizers | Static Debug/LTO Release 76/76 and shared 74/74; independent daemon/CLI over Named Pipe; real 48 kHz output and physical input adapter; ASan/UBSan 45/45 with eleven fuzzers; Bluetooth output not exposed |
...
| Linux x86_64 | runtime-verified (M5 service, WSL/null audio) | 2026-09-03 | WSL; Clang 21.1.8; GNU 15.2.0 | Static 76/76 and shared 74/74; Release+LTO Tiny/Standard/Full 75/76/75; exact 47-symbol allow-list; ABI binary/source compatibility 100%; independent daemon/CLI over mode-0600 Unix socket; evdev and native audio hardware not exposed |
